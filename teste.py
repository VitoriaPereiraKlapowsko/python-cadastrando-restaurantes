...
def cadastrar_novo_restaurante(): 
    '''Esta função realiza o cadastro de novos restaurantes''' #Usando Docstring para um melhor entendimente do código... caso outra pessoa pegue o código para entender
